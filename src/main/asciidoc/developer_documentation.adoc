...
|springframework.security                              |lottery.WebSecurityConfiguration
>>>>>>> 92510a25e9c3e3ef18a02dc537b2c1160869d047
...
[[Order]]
image:models/design/block_.png[Location, 100%, 100%, pdfwidth=100%, title= "Warenkorb", align=center] 
...
=== 6.4 Order
image:models/design/runtime_warenkorb.png[Location, 100%, 100%, pdfwidth=100%, title= "Order", align=center]
