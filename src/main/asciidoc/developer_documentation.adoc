...
|=== 
|Klasse/Enumeration |Description
|Customer|Eine Klasse, die von Salespoint-Useraccount erbt. Beschreibt einen Kunden, der ein Guthaben hat.
...
|Profile|Eine Klasse, die das Profil eines Customers verwaltet.
