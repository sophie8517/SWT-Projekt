...
|nicht registrierter Benutzer | Der nicht registrierter Benutzer ist im System angesehen als die jenige Person, die beispielsweise die Web-Seite der Lotterie zum ersten Mal besucht, d.h. laut der Aufgabenbeschreibung Ausländer,bzw. neue potenzielle Kunden. Er kann sich das Katalog der Fußballspiele anschauen, evntl. Spielregeln durchlesen, und sich registrieren, was schließlich seine Rolle als nicht registrierter Benutzer beendet.
|Administrator                |...
|System (Lotterie)            |...
|===
