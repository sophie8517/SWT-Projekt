...
Er kann sich das Katalog der Fußballspiele anschauen, evtl. Spielregeln der Zahlenloterie durchlesen, und sich registrieren, was schließlich seine Rolle als unregistrierter Benutzer beendet.
|Administrator                |
