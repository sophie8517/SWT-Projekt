...
|Auslöser              |Registration: Unregistrierter Benutzer möchte den Zutritt zur Teilnahme an den jeweiligen Angebote der Lotterie.
|Vorbedingung          |Die Person ist nicht bereits registriert.
|Grundlegende Schritte |Resgistration:
1.
