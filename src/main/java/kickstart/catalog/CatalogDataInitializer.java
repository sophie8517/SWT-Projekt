...
class CatalogDataInitializer implements DataInitializer {
	...
	public void initialize(){
		...
		Ticket t = new Ticket("name1", LocalDateTime.of(LocalDate.of(2022,1,10),
				LocalTime.of(17,15)), Money.of(7,EURO), ItemType.TICKET);
		...
		lotteryCatalog.save(new Football("name3",LocalDateTime.of(LocalDate.of(2022,3,24), LocalTime.of(17,32)),
		...
		lotteryCatalog.save(new Football("name6",LocalDateTime.of(LocalDate.of(2022,7,2), LocalTime.of(15,30)),
				Money.of(13, EURO),ItemType.FOOTBALL,new Team("FC Augsburg"), new Team("VfL Bochum"),
				"1.Bundesliga","augsburg", "bochum"));

		lotteryCatalog.save(new Football("name7",LocalDateTime.of(LocalDate.of(2022,8,12), LocalTime.of(15,30)),
		...
		lotteryCatalog.save(new Football("name11",LocalDateTime.of(LocalDate.of(2022,11,5), LocalTime.of(15,30)),
				Money.of(14, EURO),ItemType.FOOTBALL,new Team("VfB Stuttgart"), new Team("Hertha BSC"),
				"1.Bundesliga","stuttgart", "hertha"));

		lotteryCatalog.save(new Football("name12",LocalDateTime.of(LocalDate.of(2022,12,5), LocalTime.of(17,30)),
				Money.of(8, EURO),ItemType.FOOTBALL,new Team("Borussia Mönchengladbach"), new Team("SC Freiburg"),
				"1.Bundesliga","gladbach", "freiburg"));

		lotteryCatalog.save(new Football("name13",LocalDateTime.of(LocalDate.of(2022,5,3), LocalTime.of(18,30)),
				Money.of(9, EURO),ItemType.FOOTBALL,new Team("SV Darmstadt 98"), new Team("Fortuna Düssedorf"),
				"2.Bundesliga","darmstadt", "fortuna"));

		lotteryCatalog.save(new Football("name14",LocalDateTime.of(LocalDate.of(2022,5,3), LocalTime.of(18,30)),
				Money.of(10, EURO),ItemType.FOOTBALL,new Team("Werder Bremen"), new Team("FC Erzgebirge Aue"),
				"2.Bundesliga","bremen", "aue"));

		lotteryCatalog.save(new Football("name15",LocalDateTime.of(LocalDate.of(2022,4,4), LocalTime.of(13,30)),
				Money.of(8, EURO),ItemType.FOOTBALL,new Team("SV Sandhausen"), new Team("SC Paderborn"),
				"2.Bundesliga","sandhausen", "paderborn"));

		lotteryCatalog.save(new Football("name16",LocalDateTime.of(LocalDate.of(2022,9,4), LocalTime.of(13,30)),
		...
		lotteryCatalog.save(new Football("name19",LocalDateTime.of(LocalDate.of(2022,1,7), LocalTime.of(13,30)),
