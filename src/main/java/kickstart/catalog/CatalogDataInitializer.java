...
class CatalogDataInitializer implements DataInitializer {
	...
	public void initialize(){
		...
		lotteryCatalog.save(new Football("name3",LocalDateTime.of(LocalDate.of(2021,11,24), LocalTime.of(17,32)),
				Money.of(10, EURO),ItemType.FOOTBALL,new Team("TSG Hoffenheim"), new Team("RB Leipzig"),
				"1.Bundesliga","hoffenheim", "rb"));


		lotteryCatalog.save(new Football("name4",LocalDateTime.of(LocalDate.of(2021,12,3), LocalTime.of(20,30)),
				Money.of(12, EURO),ItemType.FOOTBALL,new Team("1.FC Union Berlin"), new Team("RB Leipzig"),
				"1.Bundesliga","union", "rb"));

		lotteryCatalog.save(new Football("name5",LocalDateTime.of(LocalDate.of(2021,12,4), LocalTime.of(15,30)),
				Money.of(10, EURO),ItemType.FOOTBALL,new Team("TSG Hoffenheim"), new Team("Eintracht Frankfurt"),
				"1.Bundesliga","hoffenheim", "eintracht"));

		lotteryCatalog.save(new Football("name6",LocalDateTime.of(LocalDate.of(2021,12,4), LocalTime.of(15,30)),
				Money.of(13, EURO),ItemType.FOOTBALL,new Team("FC Augsburg"), new Team("VfL Bochum"),
				"1.Bundesliga","augsburg", "bochum"));

		lotteryCatalog.save(new Football("name7",LocalDateTime.of(LocalDate.of(2021,12,4), LocalTime.of(15,30)),
